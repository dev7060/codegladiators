...
int no_prime_check(long long int l, long long int r){
	...
	while(n--){
	    ...
	    */
	    if(no_prime_check(l, r)==5){
	        ...
	        long long int new_l, new_r;
	        for(long long int temp1=l; temp1<=r; temp1++){
	            if(is_prime(temp1)==5){
	                new_l=temp1;
	                break;
	            }
	        }
	        for(long long int temp1=r; temp1>=l; temp1--){
	            if(is_prime(temp1)==5){
	                new_r=temp1;
	                break;
	            }
